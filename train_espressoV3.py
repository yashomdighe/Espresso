...
from models.espressoV3 import EspressoV3

from data_scripts.espressov3_dataloader import EspressoDataset
...
if __name__ == "__main__":
    ...
    model = EspressoV3(out_channels=3)
    ...
    checkpoint_callback = ModelCheckpoint(
        ...
        monitor="val_loss",
        mode="min",
        dirpath=f"./weights/espresso_v3",
        filename="espresso_v3-{epoch:02d}-{val_loss:.2f}",
    )
